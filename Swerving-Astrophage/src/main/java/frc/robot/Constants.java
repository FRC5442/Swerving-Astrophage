...
public final class Constants {
  ...
  /************************* DRIVE *************************/
    public static final class SwerveConstants {
        public static final double FL_OFFSET = 217; //Preferences.getDouble("FL_OFFSET", 0);//91;
        public static final double FR_OFFSET = 243; //Preferences.getDouble("FR_OFFSET", 0);//348;
